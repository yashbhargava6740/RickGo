...
public class AdminLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(android.view.View view) {
                Intent intent = new Intent(AdminLoginActivity.this, BookRikshaw.class);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                Intent intent = new Intent(AdminLoginActivity.this, PrevBookings.class);
                startActivity(intent);
            }
        });
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                Intent intent = new Intent(AdminLoginActivity.this, addDriver.class);
                startActivity(intent);
            }
        });
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(android.view.View view) {
                ...
                Intent intent = new Intent(AdminLoginActivity.this, loginForm.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void setText1(String user_id) {
                ...
                if(QS.isEmpty()) {
                    ...
                    for(QueryDocumentSnapshot qds : QS) {
                        ...
                        if ((D.getId()).equals(user_id)) {
                            ...
                            TextView uid = (TextView)findViewById(R.id.auid);
                            TextView phone = (TextView)findViewById(R.id.aphone);
